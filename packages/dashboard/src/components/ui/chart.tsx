...
>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      const itemConfig = key in config ? config[key] : config[item?.name as keyof typeof config]
      ...
      >
        ...
        <div className="grid gap-1.5">
          {payload.map((item, index) => {
            ...
            const itemConfig = key in config ? config[key] : config[item.dataKey as keyof typeof config]
                    ...
                    {!hideIndicator && (
                      <div
                        className={cn("shrink-0 rounded-[2px] border-[--color-border] bg-[--color-bg]",
                          ...
                          indicator === "dashed" && "h-0.5 w-3.5 border-t border-dashed bg-transparent"
                        )}
                        style={
                          {
